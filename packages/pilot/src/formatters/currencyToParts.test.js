...
describe('currencyToParts', () => {
  it('should return the correct value when input is 2000', () => {
    expect(currencyToParts(200000)).toEqual({ symbol: 'R$', value: '2.000,00' })
  })

  it('should return the correct value when input is 20', () => {
    expect(currencyToParts(20)).toEqual({ symbol: 'R$', value: '0,20' })
  })

  it('should return the correct value when input is 1', () => {
    expect(currencyToParts(1)).toEqual({ symbol: 'R$', value: '0,01' })
  })

  it('should return the correct value when input is 0.05', () => {
    expect(currencyToParts(0.05)).toEqual({ symbol: 'R$', value: '0,00' })
  })
  ...
  it('should return the correct value when input is 1000000000032', () => {
    expect(currencyToParts(1000000000032)).toEqual({ minusSign: undefined, symbol: 'R$', value: '10.000.000.000,32' })
  })
